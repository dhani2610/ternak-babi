...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="row">
            <form action="{{ route('kandang.update',$kandang->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="title" value="{{ $kandang->title }}" name="title" required>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="mt-2" for="jenis">Size</label>
                                        <input type="text" class="form-control" id="size" value="{{ $kandang->size }}" name="size" required>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="mt-2" for="jenis">Max Ternak</label>
                                        <input type="number" class="form-control" id="max_ternak" value="{{ $kandang->max_ternak }}" name="max_ternak" required>
                                    </div>
                                </div>
                            </div>
