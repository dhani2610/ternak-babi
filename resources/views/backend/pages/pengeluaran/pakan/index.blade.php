    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title float-left">Data Pengeluaran Pakan</h4>
                        <p class="float-right mb-2">
                            <a href="{{ route('pengeluaran-pakan.create') }}" class="btn btn-primary text-white mb-3" style="float: right">
                                Tambah Data
                            </a>
                        </p>
                                ...
                                <tbody>
                                    @foreach ($data as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="confirmDelete('{{ route('pengeluaran-pakan.destroy', $item->id) }}')"
